	...
	return (
		<section className='startingpage'>
				...
				<div className='hero-img-container'>
					<img src={burgersStart} /><h2 className='head_bliss'>FEEL THE BLISS!</h2>
				</div>
			...
			<section className='landingpage_text_container'>
				...
				<h2>NYHET!</h2>
				<div>
					<p className='news text_padding'>Ligg i framkant med oss och kolla in vår nya burgare <span className='strong'>"Bliss Future Burger"</span> med 3D-printant kött.</p>
				</div>
			...
			<section id='about_us' className='about_us_container'>
				...
				<div className='align_imgs splashburger_img'><img src={splashBurger}/></div>
				...
				<div className='align_imgs tomatoes_img'><img src={tomatoes} /></div>

				<h3 className='head_sustainability'>VÅR HÅLLBARHETSMISSION</h3>
				<div className='text'>
					<p className='text_padding sus_one '><span> 1. Miljövänlig matlagning:</span> På BurgerBliss är vi passionerade när det gäller att skapa de mest utsökta burgarna samtidigt som vi arbetar för att minska vår miljöpåverkan. Vi källsorterar vårt avfall noggrant, använder energieffektiva apparater i vår restaurang och samarbetar nära lokala bönder för att minska vårt koldioxidavtryck.</p>
				</div>
				<div>
					<p className='text_padding sus_two'><span> 2. Plastminimering:</span> Vi arbetar aktivt på att minska vår användning av engångsplast i våra förpackningar och uppmanar våra gäster att vara med oss i detta arbete genom återanvändning och återvinning. Tillsammans strävar vi mot en mer hållbar framtid.</p>
				</div>
				<div className='align_imgs cows_img'>
					<img src={cows}/>
				</div>
				<div>
					<p className='text_padding sus_three'><span> 3. 3D-utskrivet kött:</span> Vi är stolta över att erbjuda 3D-utskrivet kött som ett alternativ. Detta är ett mer hållbart val som kräver betydligt färre naturresurser och mark än traditionell köttproduktion, samtidigt som det levererar den fantastiska smakupplevelse du förväntar dig.</p>
				</div>
